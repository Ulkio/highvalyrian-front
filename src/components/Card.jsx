...
const Card = ({ glyph, onClick, mobileView }) => {
  return (
    <article
      ...
      }  text-center bg-white-custom  text-dark rounded-2xl shadow-xl flex flex-col items-center justify-between py-4 hover:cursor-pointer hover:scale-[1.02] transition duration-100`}>
